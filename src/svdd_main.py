...
from datasets.main import svdd_load_dataset
...
def main(dataset_name, net_name, xp_path, data_path, load_config, load_model, objective, nu, device, seed,
         ...
         ae_n_epochs, ae_lr_milestone, ae_batch_size, ae_weight_decay, n_jobs_dataloader, normal_class, random_state):
    """
    ...
    # Load data
    dataset = svdd_load_dataset(dataset_name, data_path, normal_class, random_state)
    ...
    # if dataset_name in ('mnist', 'cifar10', 'lg_train'):
